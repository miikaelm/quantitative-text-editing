...
HARDCODED_COLOR_PAIRS: list[EditPair] = [
    ...
    _make_color_pair(17, "h1", "#fffff0", "#F59E0B", "NATURE", bg="url('https://picsum.photos/seed/nature/800/600') center/cover no-repeat"),
    ...
    _make_color_pair(21, "h1", "#1a202c", "#F43F5E", "CORAL REEF", bg="#ffe4e6"),
    _make_color_pair(22, "p", "#e2e8f0", "#38BDF8", "Deep ocean paragraph text.", font_size="24px", bg="#0f172a"),
    _make_color_pair(23, "h2", "#2d3748", "#D97706", "Sunset Boulevard", font_size="44px", bg="linear-gradient(to top, #ffecd2 0%, #fcb69f 100%)"),
    _make_color_pair(24, "h1", "#f8fafc", "#A855F7", "NEON NIGHTS", bg="#09090b"),
    _make_color_pair(25, "h3", "#064e3b", "#14B8A6", "Forest Canopy Subheading", font_size="38px"),
    _make_color_pair(26, "p", "#475569", "#F97316", "A warm, inviting text snippet for a blog post.", font_size="28px", bg="#fff7ed"),
    _make_color_pair(27, "h1", "#000000", "#EC4899", "VAPORWAVE", bg="linear-gradient(to right, #4facfe 0%, #00f2fe 100%)"),
    _make_color_pair(28, "h2", "#ffffff", "#E11D48", "Crimson Peak", font_size="50px", bg="radial-gradient(circle at center, #7f0020 0%, #000000 100%)"),
    _make_color_pair(29, "h1", "#1e293b", "#3B82F6", "BLUEPRINT", bg="#0f172a; background-image: linear-gradient(rgba(59, 130, 246, 0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(59, 130, 246, 0.2) 1px, transparent 1px); background-size: 30px 30px"),
    _make_color_pair(30, "p", "#f1f5f9", "#22C55E", "Eco-friendly sustainability message.", font_size="30px", bg="#14532d"),
    _make_color_pair(31, "h1", "#ffffff", "#F59E0B", "SUNBURST", bg="repeating-radial-gradient(circle, #fbbf24, #fbbf24 10px, #f59e0b 10px, #f59e0b 20px)"),
    ...
    _make_color_pair(34, "p", "#7f1d1d", "#DC2626", "Warning message containing critical alerts.", font_size="26px", bg="repeating-linear-gradient(45deg, #fee2e2, #fee2e2 10px, #fecaca 10px, #fecaca 20px)"),
    _make_color_pair(35, "h1", "#fbbf24", "#94A3B8", "LUXURY", bg="linear-gradient(135deg, #111827 0%, #374151 100%)"),
    _make_color_pair(36, "h2", "#022c22", "#10B981", "Minty Fresh", font_size="46px", bg="linear-gradient(120deg, #d4fc79 0%, #96e6a1 100%)"),
    _make_color_pair(37, "h1", "#0f172a", "#38BDF8", "WINTER BREEZE", bg="linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%)"),
    ...
    _make_color_pair(40, "h1", "#ffffff", "#F472B6", "COTTON CANDY", bg="radial-gradient(circle, #ffc3a0 0%, #ffafbd 100%)"),
    _make_color_pair(41, "h1", "#f8fafc", "#22C55E", "MOUNTAINS", bg="url('https://picsum.photos/seed/mountain/800/600') center/cover no-repeat"),
    _make_color_pair(42, "h2", "#ffffff", "#F97316", "Desert Sand Overlay", font_size="52px", bg="linear-gradient(rgba(120,53,15,0.6), rgba(120,53,15,0.6)), url('https://picsum.photos/seed/desert/800/600') center/cover"),
    _make_color_pair(43, "p", "#e2e8f0", "#60A5FA", "A description of a futuristic tech startup.", font_size="28px", bg="linear-gradient(rgba(15,23,42,0.85), rgba(15,23,42,0.85)), url('https://picsum.photos/seed/tech/800/600') center/cover"),
    _make_color_pair(44, "h1", "#000000", "#EAB308", "BRUTALISM", font_size="72px", bg="#94a3b8"),
    _make_color_pair(45, "h3", "#ffffff", "#EF4444", "Space Exploration", font_size="44px", bg="url('https://picsum.photos/seed/space/800/600') center/cover"),
    _make_color_pair(46, "p", "#064e3b", "#84CC16", "Organic farming initiatives and community gardens.", font_size="32px", bg="linear-gradient(rgba(240,2df,244,0.9), rgba(240,253,244,0.9)), url('https://picsum.photos/seed/leaves/800/600') center/cover"),
    _make_color_pair(47, "h1", "#ffffff", "#A855F7", "CYBERPUNK", bg="linear-gradient(135deg, rgba(88,28,135,0.8), rgba(15,23,42,0.9)), url('https://picsum.photos/seed/neon/800/600') center/cover"),
    _make_color_pair(48, "h2", "#ffffff", "#F472B6", "Metropolitan", font_size="48px", bg="linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://picsum.photos/seed/architecture/800/600') center/cover"),
    _make_color_pair(49, "h1", "#0c4a6e", "#0EA5E9", "OCEAN WAVES", bg="linear-gradient(rgba(224,242,254,0.7), rgba(224,242,254,0.7)), url('https://picsum.photos/seed/water/800/600') center/cover"),
    _make_color_pair(50, "p", "#fef9c3", "#EAB308", "Historical context reflecting golden era architecture.", font_size="30px", bg="linear-gradient(rgba(69,26,3,0.8), rgba(69,26,3,0.8)), url('https://picsum.photos/seed/history/800/600') center/cover"),
    _make_color_pair(51, "h1", "#22C55E", "#10B981", "THE MATRIX", bg="linear-gradient(180deg, #022c22 0%, #000000 100%)"),
    ...
    _make_color_pair(55, "h1", "#ffffff", "#FB7185", "RETRO 80S", bg="linear-gradient(135deg, #1e1b4b 0%, #312e81 100%); border-bottom: 4px solid #f43f5e"),
    ...
    _make_color_pair(57, "p", "#e0e7ff", "#F59E0B", "Creative agency introductory boilerplate.", font_size="28px", bg="#1e1b4b"),
    _make_color_pair(58, "h1", "#ffffff", "#22C55E", "TROPICAL", bg="url('https://picsum.photos/seed/tropical/200/200') repeat"),
    _make_color_pair(59, "h3", "#1c1917", "#FBBF24", "Sunlight Beam", font_size="42px", bg="linear-gradient(45deg, #fffbeb 0%, #fde68a 50%, #fffbeb 100%)"),
    _make_color_pair(60, "h1", "#f8fafc", "#6366F1", "DEEP SPACE", bg="radial-gradient(ellipse at bottom, #1b2735 0%, #090a0f 100%)"),
    _make_color_pair(61, "h1", "#1c1c1c", "#2563EB", "Quantum Flux Analyzer", bg="#f1f5f9"),
    _make_color_pair(62, "p", "#404040", "#0D9488", "The quick brown fox leaps over the completely indifferent dog.", font_size="22px"),
    ...
    _make_color_pair(64, "h1", "#0b0b0b", "#BE185D", "GALAXY EXPRESS 999", bg="#fce7f3"),
    _make_color_pair(65, "h3", "#1e293b", "#0284C7", "System Diagnostics: Nominal", font_size="36px"),
    _make_color_pair(66, "p", "#52525B", "#EA580C", "To bake the perfect loaf of bread, you need patience, flour, and a very hot oven.", font_size="26px", bg="#fafaf9"),
    _make_color_pair(67, "h1", "#ffffff", "#D946EF", "SYNTHWAVE RADIO", bg="linear-gradient(to right, #6b21a8 0%, #312e81 100%)"),
    ...
    _make_color_pair(69, "h1", "#0f172a", "#1D4ED8", "ARCHITECTURE", bg="#e0e7ff; background-image: repeating-linear-gradient(0deg, transparent, transparent 19px, #c7d2fe 19px, #c7d2fe 20px)"),
    _make_color_pair(70, "p", "#f8fafc", "#16A34A", "Photosynthesis is the process used by plants, algae and certain bacteria.", font_size="28px", bg="#14532d"),
    _make_color_pair(71, "h1", "#333333", "#D97706", "MORNING COFFEE", bg="repeating-radial-gradient(circle, #fef3c7, #fef3c7 15px, #fde68a 15px, #fde68a 30px)"),
    ...
    _make_color_pair(74, "p", "#7f1d1d", "#E11D48", "Please ensure all safety harnesses are securely fastened before the ride begins.", font_size="24px", bg="repeating-linear-gradient(-45deg, #fee2e2, #fee2e2 15px, #fecaca 15px, #fecaca 30px)"),
    _make_color_pair(75, "h1", "#fcd34d", "#CBD5E1", "PREMIUM MEMBERSHIP", bg="linear-gradient(135deg, #18181b 0%, #27272a 100%)"),
    _make_color_pair(76, "h2", "#064e3b", "#059669", "Eucalyptus Leaves", font_size="48px", bg="linear-gradient(120deg, #d9f99d 0%, #bbf7d0 100%)"),
    _make_color_pair(77, "h1", "#020617", "#0284C7", "GLACIER MELT", bg="linear-gradient(to bottom, #f1f5f9 0%, #e2e8f0 100%)"),
    ...
    _make_color_pair(80, "h1", "#ffffff", "#F43F5E", "CHERRY BLOSSOM", bg="radial-gradient(circle, #fda4af 0%, #fb7185 100%)"),
    _make_color_pair(81, "h1", "#f1f5f9", "#16A34A", "HIKING TRAILS", bg="url('https://picsum.photos/seed/hike/800/600') center/cover no-repeat"),
    _make_color_pair(82, "h2", "#ffffff", "#EA580C", "Martian Landscape", font_size="54px", bg="linear-gradient(rgba(153,27,27,0.7), rgba(153,27,27,0.7)), url('https://picsum.photos/seed/mars/800/600') center/cover"),
    _make_color_pair(83, "p", "#f8fafc", "#3B82F6", "Our new machine learning models have reached 99.8% accuracy on the validation set.", font_size="28px", bg="linear-gradient(rgba(30,58,138,0.9), rgba(30,58,138,0.9)), url('https://picsum.photos/seed/data/800/600') center/cover"),
    _make_color_pair(84, "h1", "#171717", "#CA8A04", "CONCRETE JUNGLE", font_size="68px", bg="#a1a1aa"),
    _make_color_pair(85, "h3", "#ffffff", "#DC2626", "Event Horizon", font_size="46px", bg="url('https://picsum.photos/seed/galaxy/800/600') center/cover"),
    _make_color_pair(86, "p", "#065f46", "#65A30D", "Locally sourced organic vegetables delivered straight to your door.", font_size="32px", bg="linear-gradient(rgba(236,253,245,0.85), rgba(236,253,245,0.85)), url('https://picsum.photos/seed/farm/800/600') center/cover"),
    _make_color_pair(87, "h1", "#ffffff", "#9333EA", "NEON CITYSCAPES", bg="linear-gradient(135deg, rgba(107,33,168,0.85), rgba(2,6,23,0.95)), url('https://picsum.photos/seed/tokyo/800/600') center/cover"),
    _make_color_pair(88, "h2", "#f8fafc", "#F472B6", "Vintage Cinema", font_size="48px", bg="linear-gradient(rgba(24,24,27,0.6), rgba(24,24,27,0.6)), url('https://picsum.photos/seed/film/800/600') center/cover"),
    _make_color_pair(89, "h1", "#082f49", "#0284C7", "PACIFIC TRENCH", bg="linear-gradient(rgba(186,230,253,0.75), rgba(186,230,253,0.75)), url('https://picsum.photos/seed/ocean/800/600') center/cover"),
    _make_color_pair(90, "p", "#fef08a", "#D97706", "The ancient ruins were discovered deep within the uncharted rainforest.", font_size="28px", bg="linear-gradient(rgba(69,26,3,0.85), rgba(69,26,3,0.85)), url('https://picsum.photos/seed/ruins/800/600') center/cover"),
    _make_color_pair(91, "h1", "#16A34A", "#059669", "TERMINAL ROOT", bg="linear-gradient(180deg, #064e3b 0%, #020617 100%)"),
    ...
    _make_color_pair(95, "h1", "#ffffff", "#FB7185", "MIAMI NIGHTS", bg="linear-gradient(135deg, #312e81 0%, #4c1d95 100%); border-left: 8px solid #f43f5e"),
    ...
    _make_color_pair(97, "p", "#e0e7ff", "#D97706", "Welcome to the interactive onboarding module. Please click next to continue.", font_size="28px", bg="#312e81"),
    _make_color_pair(98, "h1", "#ffffff", "#16A34A", "BOTANICAL GARDENS", bg="url('https://picsum.photos/seed/plants/250/250') repeat"),
    ...
    _make_color_pair(100, "h1", "#f1f5f9", "#4F46E5", "STELLAR CARTOGRAPHY", bg="radial-gradient(ellipse at top right, #1e293b 0%, #0f172a 100%)"),
    _make_color_pair(101, "h1", "#212121", "#FF5722", "RUSTIC CHARM", bg="url('https://picsum.photos/seed/wood/800/600') center/cover"),
    _make_color_pair(102, "p", "#E2E8F0", "#14B8A6", "The database migration completed successfully with zero downtime.", font_size="20px", bg="#0F172A"),
    ...
    _make_color_pair(105, "p", "#10B981", "#34D399", "admin@server:~$ ./execute_protocol.sh --force", font_size="18px", bg="#000000"),
    _make_color_pair(106, "h1", "#FFFFFF", "#F43F5E", "LAVA FLOW", bg="linear-gradient(to bottom right, #7F1D1D, #000000)"),
    ...
    _make_color_pair(108, "h1", "#FEF3C7", "#D97706", "SEPIA TONES", bg="linear-gradient(rgba(120,53,15,0.8), rgba(120,53,15,0.8)), url('https://picsum.photos/seed/oldphoto/800/600')"),
    _make_color_pair(109, "p", "#333333", "#4F46E5", "User engagement increased by 45% after implementing the new feature set.", font_size="24px", bg="#F3F4F6"),
    _make_color_pair(110, "h3", "#F1F5F9", "#94A3B8", "Steel Interface", font_size="40px", bg="linear-gradient(135deg, #475569 0%, #1E293B 100%)"),
    _make_color_pair(111, "h1", "#FFFFFF", "#10B981", "VINTAGE BOTANICAL", bg="linear-gradient(rgba(6,78,59,0.7), rgba(6,78,59,0.7)), url('https://picsum.photos/seed/fern/800/600')"),
    ...
    _make_color_pair(113, "p", "#FFFFFF", "#F59E0B", "He stepped into the room, and the temperature immediately dropped by ten degrees.", font_size="28px", bg="conic-gradient(from 180deg, #111827, #374151, #111827)"),
    _make_color_pair(114, "h1", "#111827", "#8B5CF6", "AMETHYST", bg="#EED2EE; background-image: radial-gradient(#D8BFD8 1px, transparent 1px); background-size: 10px 10px"),
    _make_color_pair(115, "h3", "#FFFFFF", "#06B6D4", "Iced Over", font_size="46px", bg="linear-gradient(to top, #cffafe 0%, #083344 100%)"),
    _make_color_pair(116, "p", "#4C1D95", "#A855F7", "Please verify your email address to unlock premium features and daily rewards.", font_size="26px", bg="#FAF5FF"),
    ...
    _make_color_pair(119, "h1", "#F8FAFC", "#64748B", "MONOLITH", bg="#0F172A; box-shadow: inset 0 0 50px #000"),
    ...
    _make_color_pair(122, "h1", "#022C22", "#10B981", "CHLOROPHYLL", bg="#D1FAE5"),
    _make_color_pair(123, "h2", "#FFFFFF", "#A3E635", "Toxic Sludge", font_size="54px", bg="linear-gradient(135deg, #3F6212 0%, #14532D 100%)"),
    _make_color_pair(124, "p", "#292524", "#A8A29E", "A whisper of wind brushed past the ancient, crumbling stone walls.", font_size="24px", bg="#F5F5F4"),
    _make_color_pair(125, "h1", "#F1F5F9", "#0EA5E9", "STRATOSPHERE", bg="linear-gradient(to top, #38BDF8 0%, #0284C7 100%)"),
    ...
    _make_color_pair(127, "p", "#F3E8FF", "#C026D3", "Magic is just science that we haven't documented properly yet.", font_size="30px", bg="linear-gradient(rgba(49,46,129,0.7), rgba(49,46,129,0.7)), url('https://picsum.photos/seed/magic/800/600') center/cover"),
    _make_color_pair(128, "h1", "#000000", "#14B8A6", "CYBER SECURITY", bg="repeating-linear-gradient(90deg, #CCFBF1 0%, #CCFBF1 5%, #99F6E4 5%, #99F6E4 10%)"),
    ...
    _make_color_pair(130, "p", "#1F2937", "#6B7280", "Section 4: Hardware specifications and minimum system requirements.", font_size="20px", bg="#E5E7EB"),
    _make_color_pair(131, "h1", "#F8FAFC", "#6366F1", "WORMHOLE", bg="radial-gradient(circle at 50% 50%, #312E81 0%, #000000 100%)"),
    ...
    _make_color_pair(134, "h1", "#27272A", "#D4D4D8", "BRUSHED METAL", bg="linear-gradient(90deg, #e4e4e7 0%, #f4f4f5 50%, #e4e4e7 100%)"),
    _make_color_pair(135, "h2", "#FFFFFF", "#FCD34D", "Golden Ratio", font_size="40px", bg="linear-gradient(rgba(180,83,9,0.8), rgba(180,83,9,0.8)), url('https://picsum.photos/seed/math/800/600')"),
    _make_color_pair(136, "p", "#4C1D95", "#8B5CF6", "They danced until the stars faded and the morning sun broke the horizon.", font_size="28px", bg="linear-gradient(to right, #EDE9FE 0%, #DDD6FE 100%)"),
    ...
    _make_color_pair(139, "p", "#064E3B", "#10B981", "ERROR: Variable 'x' is undefined on line 42 of script.js.", font_size="22px", bg="#D1FAE5; border-left: 6px solid #10B981"),
    _make_color_pair(140, "h1", "#FFFFFF", "#E879F9", "KALEIDOSCOPE", bg="conic-gradient(from 0deg, #ef4444, #f97316, #eab308, #22c55e, #3b82f6, #a855f7, #ef4444)"),
]
